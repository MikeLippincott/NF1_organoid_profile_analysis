...
figures_path <- file.path(root_dir,"4.linear_modeling/figures/linear_modeling/")
...
organoid_fs_lm_results_path <- file.path(
    root_dir,
    "4.linear_modeling/results/linear_modeling/organoid_fs.parquet"
)
...
sc_fs_lm_results_path <- file.path(
    root_dir,
    "4.linear_modeling/results/linear_modeling/sc_fs.parquet"
)
