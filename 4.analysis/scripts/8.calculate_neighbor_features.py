...
Metadata_Neighbors_DistancesFromExterior. These are genuinely different
...
results_dir = root_dir / "4.analysis" / "results" / "neighbors"
...
for patient in patients_3d:
    ...
    # DistancesFromCenter/FromExterior are stored as arrays (per-neighbor); take mean per nucleus
    for col in [
        "Metadata_Neighbors_DistancesFromCenter",
        "Metadata_Neighbors_DistancesFromExterior",
    ]:
